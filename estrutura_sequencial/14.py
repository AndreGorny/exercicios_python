...
if peso > 50:
    excesso = peso - 50
    multa = excesso * 4
    print(f"O peso total excedeu em {excesso}kg a cota de 50kg.")
    print(f"A multa a pagar é de R${multa:,.2f}.")
else:
    print("O peso total está dentro da cota de 50kg. Sem multa a pagar.")
